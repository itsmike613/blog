export const posts = [
    {
        ...
        content: `
            ...
            <ol>
                <li>I wanted a space that is mine, not controlled by social media.</li>
                <li>I have thoughts that are too long for a post with a character limit.</li>
                <li>I want to document my experiences, ideas, and thoughts instead of keeping them in my head. I also want to share different perspectives and hear feedback from others, which is why every post has a comment section.</li>
                <li>I want a place where opinions can be explained with context. I hope people read from start to finish so they can understand another person's perspective, even if they do not fully agree with it.</li>
            </ol>
